...
const I18N_DA = {
  ...
  // --- Brand marquee ---
  'brand.head': `Betroet af ambitiøse brands på tværs af <strong>10+ markeder</strong>`,

  // --- About ---
  'about.tag': '• Om Hero Media',
  'about.title': 'Det oplagte valg for ambitiøse virksomheder, der vil vokse online.',
  'about.body': 'Vi hjælper ambitiøse virksomheder med at vokse deres online tilstedeværelse med et klart fokus på at levere målbare resultater. Alt, hvad vi skaber, er designet til at flytte dit brand fremad.',
  ...
  // --- Framer section ---
  'framer.heading.lead': 'Vi hjælper ambitiøse brands med at forvandle annoncekroner til vækst, der',
  ...
  'results.partners.label': 'Betroet af ambitiøse brands',
