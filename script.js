...
const I18N_DA = {
  ...
  'nav.cta.short': 'Book et gratis møde',
  ...
  'hero.sub.m1': 'Strategi, content, funnels og ads.',
  'hero.sub.m2': 'Marketing, der flytter bundlinjen.',
  ...
  'about.title': 'Det oplagte valg, når du vil vokse online.',
  'about.body': 'Målbare resultater. Det er vores ene fokus, når vi vokser din virksomhed online.',
  ...
  // --- Framer section ---
  'framer.heading.lead': 'Vi gør annoncekroner til vækst, der',
  'framer.rotator.1': 'konverterer.',
  'framer.rotator.2': 'skalerer.',
  'framer.rotator.3': 'dominerer.',
  'framer.rotator.4': 'holder.',
  ...
  'framer.stat.1': 'USD i annoncebudget på tværs af 10 markeder',
  'framer.stat.2': 'Års erfaring',
  'framer.stat.3': 'USD i annoncebudget styret hver måned',
  ...
  'case.1.desc': 'Funnel-optimering og lokale annoncer, der fyldte kalenderen i et premium studie.',
  'case.1.m1': '184% Flere bookinger',
  'case.1.m2': '3,4x Leadvolumen',
  'case.2.desc': 'Målrettede kampagner og en stærk digital tilstedeværelse, der løftede salget.',
  'case.2.m1': '151% Øget trafik',
  'case.2.m2': '262% Vækst i salg',
  'case.3.desc': 'Ny hjemmeside og annoncer skræddersyet til målgruppen, der løftede omsætningen.',
  'case.3.m1': '57% Hjemmesidebesøgende',
  'case.3.m2': '92% Øget omsætning',
  'case.4.desc': 'Paid social og stærke kreativer, der skalerede budgettet profitabelt.',
  'case.4.m1': '4,2x ROAS',
  'case.4.m2': '118% Omsætningsvækst',
  'case.5.desc': 'Lead-funnels og retargeting, der fylder fitnesscentret med nye medlemmer.',
  'case.5.m1': '240% Flere medlemskaber',
  'case.5.m2': '67% Lavere CPA',

  // --- Process ---
  'process.tag': '• Sådan arbejder vi',
  'process.title': `<em>Handling frem for ord.</em> <br />Derfor vælger de os.`,
  ...
  'stage.1.body': 'Vi sætter retningen. Dine mål, din målgruppe og din positionering bliver til ét kreativt koncept, der styrer alle kampagner.',
  'stage.2.tag': 'Fase 2',
  'stage.2.title': 'Content',
  'stage.2.body': 'Tekst og visuals, der gør strategien levende, engagerer målgruppen og rammer budskabet klart.',
  'stage.3.tag': 'Fase 3',
  'stage.3.title': 'Funnels',
  'stage.3.body': 'Funnels, kampagnestruktur og annoncer, der fører målgruppen fra første klik til konvertering.',
  'stage.4.tag': 'Fase 4',
  'stage.4.title': 'Post Production',
  'stage.4.body': 'Vi finpudser hvert asset, så alt er poleret, afstemt og klar til lancering. Kvalitet og konsistens til sidst.',

  // --- Results ---
  'results.tag': '• Dokumenterede resultater',
  'results.title': `Tal, der <em>flytter virksomheder</em>.`,
  ...
  'result.r5.headline': 'Flere medlemmer, lav CPA',
  ...
  'bento.hero.quote': '"Bookingerne tredobledes på tre måneder. Ingen har leveret så hurtigt."',
  'bento.hero.s1': 'Bookinger',
  'bento.hero.s2': 'Leadvolumen',
  'bento.hero.s3': 'Lavere CPA',
  'bento.parfume.sub': 'Afkast på annoncekroner',
  'bento.parfume.note': 'Kreativer og CRO skalerede budgettet uden at sprænge marginen.',
  ...
  'reviews.sub': 'Det siger vores kunder om samarbejdet.',
  ...
  'usp.2.body': 'Vi optimerer for omsætning, ikke for tal, der bare ser flotte ud.',
  'usp.3.title': 'Senior team, direkte',
  'usp.3.body': 'Du arbejder direkte med de strateger, der bygger planen. Ingen juniorer imellem.',
